...
import dao.InDataBaseStudentRepository;
...
public class SchoolService {
    private final StudentReepository studentRepository;
    private ModuleRepository moduleRepository;

    public SchoolService(StudentReepository studentRepository) {
        this.studentRepository = studentRepository;
    }

    public SchoolService(StudentReepository studentRepository, ModuleRepository moduleRepository) {
